...
CREATE OR REPLACE FUNCTION update_admin_building_assignments_updated_at()
RETURNS TRIGGER AS $$
BEGIN
...
CREATE TRIGGER update_admin_building_assignments_updated_at
    BEFORE UPDATE ON admin_building_assignments
    FOR EACH ROW
